...
public record AlphaNumericSpecialEMVTag(LimitNumber min, LimitNumber max) implements EMVTagFormat<String> {
    private static final String ALPHA_NUM_SPEC_REGEX =
        "[A-Za-z0-9 \\!\\”\\#\\$\\%\\&\\'\\(\\)\\*\\+\\,\\-\\.\\/\\:\\;\\<\\=\\>\\?\\@\\[\\\\\\]\\^\\_\\`\\{\\|\\}\\~]*";
    ...
    public boolean validateTagValue(byte[] tagValue) {
        ...
        return strRepr.matches(ALPHA_NUM_SPEC_REGEX);
    }
